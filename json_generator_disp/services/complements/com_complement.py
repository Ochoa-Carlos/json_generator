...
class ComComplement(ComplementBase):
    """Complement Comercializacion build class."""
    ...
    def build_complement(self):
        ...
        print("=================>BUILD COMERCIALIZACION COMPLEMETN<=================")
        complement_list = []
        for cf_index, _ in enumerate(self.cfdis):
            complement_dict = {"TipoComplemento": ComplementTypeEnum.COMERCIALIZACION.value}
